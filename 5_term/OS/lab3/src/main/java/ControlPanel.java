...
public class ControlPanel extends Frame {
    ...
    Label pageFaultCountLabel = new Label("0", Label.LEFT);
    ...
    public void init(Kernel useKernel, String commands, String config) {
        ...
        pageFaultCountLabel.reshape(385, 105 + 25, 100, 15);
        add(pageFaultCountLabel);
        ...
        Label pageFaultCountLabel = new Label("faults number: ", Label.LEFT);
        pageFaultCountLabel.reshape(285, 105 + 25, 100, 15);
        add(pageFaultCountLabel);
