...
public class UserInterface extends JFrame{
    ...
    UserInterface(){
        ...
        comboSection.addActionListener (new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                ...
                section = SectionDAO.findByName((String) comboSection.getSelectedItem());
                sectionMode = true;
                sectionPanel.setVisible(true);
                goodPanel.setVisible(false);
                fillSectionFields();
        ...
        comboGood.addActionListener (new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                ...
                good = GoodDAO.findByName((String) comboGood.getSelectedItem());
                sectionMode = false;
                sectionPanel.setVisible(false);
                goodPanel.setVisible(true);
                fillGoodFields();
    ...
    private static void save() {
        if(editMode) {
            if(sectionMode) {
                ...
                Section section = SectionDAO.findByName(tfGoodSectionName.getText());
                if(section == null) {
    ...
    private static void delete() {
        if(editMode) {
            if(sectionMode) {
                var list = GoodDAO.findBySectionId(section.getId());
                for(Good good: list) {
    ...
    private static void fillGoodFields() {
        if(good == null)
            return;
        Section section = SectionDAO.findById(good.getSectionId());
