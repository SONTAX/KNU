...
public class Program {public static final int N = 10;
    private static final String file = "src\\main\\java\\lab4\\b\\output.txt";
    private static final Random rand = new Random();
    // 0 - watered, 1 - not watered
    private static final int[][] field = new int[N][N];
    ...
    public static class Monitor1 implements Runnable {
        public void run() {
            FileWriter fw = null;
            try {
    ...
    public static class Monitor2 implements Runnable {
        public void run() {
            while(!Thread.currentThread().isInterrupted()) {
                try {
                    lock.lockRead();
